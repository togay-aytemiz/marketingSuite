                            ...
                            <div className="space-y-3">
                              <div className="space-y-1">
                                <label className="block text-[11px] font-semibold uppercase tracking-widest text-zinc-500">
                                  Shared Headline (sent to Gemini)
                                </label>
                                <input
                                  type="text"
                                  ...
                                  placeholder="Gemini headline plan"
                                />
                              </div>

                              <div className="space-y-1">
                                <label className="block text-[11px] font-semibold uppercase tracking-widest text-zinc-500">
                                  Shared Subheadline (sent to Gemini)
                                </label>
                                <textarea
                                  ...
                                  placeholder="Gemini subheadline plan"
                                />
                              </div>
                            </div>
                            ...
                            {state.socialPostPromptPlans[index] ? (
                              <div className="mt-3 rounded-xl border border-zinc-200 bg-white p-3">
                                <div className="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-widest text-zinc-500">
                                  ...
                                  Planned Prompt (visual direction)
                                </div>
      ...
      <div className="p-4 border-t border-zinc-100 bg-white">
        <div className="space-y-2">
          ...
          <p className="px-1 text-[11px] leading-5 text-zinc-500">
            Review or edit the shared headline and subheadline first. Gemini renders the final image with this copy; the app does not add a second overlay.
          </p>
        </div>
      </div>
    </div>
